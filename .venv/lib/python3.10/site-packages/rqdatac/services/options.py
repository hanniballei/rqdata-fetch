...
OPTION_INDICATORS = ['VL_PCR', 'OI_PCR', 'AM_PCR', "skew", "iv_025_dela", "iv_minus_025_dela"]
...
def get_indicators(underlying_symbols, maturity, start_date=None, end_date=None, fields=None, market='cn'):
    ...
    fields : str | list[str], optional
        ...
        - 'iv_025_dela': 0.25delta 隐含波动率
        - 'iv_minus_025_dela': -0.25delta 隐含波动率
    market : str, optional
        默认是中国内地市场('cn') 。可选'cn' - 中国内地市场；
    ...
    pandas.DataFrame
        ...
        - skew : float, 期权偏度
        - iv_025_dela: float, 0.25delta 隐含波动率
        - iv_minus_025_dela: float, -0.25delta 隐含波动率
    ...
    >>> options.get_indicators('510050.XSHG','2502','20250101', '20250103')
                            AM_PCR   OI_PCR  VL_PCR  skew  iv_025_dela  iv_minus_025_dela
    underlying_symbol   date
    510050.XSHG  2025-01-02  1.132778  0.919209  1.036258  0.061745  0.203776  0.191926
                  2025-01-03  1.171061  0.961585  0.920874  0.01549  0.195894  0.192906
