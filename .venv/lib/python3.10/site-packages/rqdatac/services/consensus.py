...
def get_expect_prob(order_book_ids, expect_prob, start_date=None, end_date=None):
    ...
    Examples
    --------
    获取 2025 年 12 月 18 日 000001.XSHG 低于预期的数据

    >>> rqdatac.consensus.get_expect_prob('000001.XSHG', expect_prob='below', start_date=20251218, end_date=20251218)

                              report_year report_period  info_classification       institute                                   info_summary  ... con_profit_gr_last con_profit_gr_q_last expect_rate      rice_create_tm           create_tm
    order_book_id date                                                                                                                       ...
    000001.XSHG   2025-12-18         2025            q4                 2101  Morgan Stanley  Morgan Stanley2025-12-18发布的报告下调了该股盈利预测,分析师：徐然  ...               None                 None     -0.0025 2025-12-20 04:58:37 2025-12-20 04:58:37
    """
